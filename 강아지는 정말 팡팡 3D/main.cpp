...
int main(int argc, char** argv) //--- 윈도우 출력하고 콜백함수 설정
{
	...
	glutCreateWindow("♬ 강아지는 정말 팡팡 3D ♪"); // 윈도우 생성(윈도우 이름)

	std::cout << "==================== 명령어 ====================" << std::endl;
	std::cout << " " << std::endl;
	std::cout << "♥♡ x: 카메라 x축 방향으로 이동 ♡♥" << std::endl;
	std::cout << "♥♡ z: 카메라 z축 방향으로 이동 ♡♥" << std::endl;
	std::cout << " " << std::endl;
	std::cout << "♥♡ W/S/A/D: 강아지 이동 ♡♥" << std::endl;
	std::cout << "♥♡ ↑/↓/←/→: 카메라 이동 ♡♥" << std::endl;
	std::cout << " " << std::endl;
	std::cout << "♥♡ q/Q 또는 ESC: 게임 종료 T-T ♡♥" << std::endl;
...
GLvoid drawScene()
{
	...
	// 배경 색상
	glClearColor(0.9255f, 0.6745f, 1.0f, 1.0f);
